 ...
 * @author daniel
 */
public class BancoView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Pesquisa Banco"));
   ...
   //   Principal.bancoMenuItem.setEnabled(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            if (javax.swing.JOptionPane.showConfirmDialog(null, "Deseja Realmente Excluir este Banco?", "ATENÇÂO ", javax.swing.JOptionPane.YES_NO_OPTION) == 0) {
            
            BancoDAO bancoDAO = new BancoDAO();
            bancoDAO.excluir(carregaObjeto());
            JOptionPane.showMessageDialog(null, "Banco Excluída com Sucesso !!!");
            jbtCancelarActionPerformed(evt);
        }
    ...
    private Banco carregaObjeto(){
      ...
      //  
        if (operacao == "alterar" )
            banco.setId((Long) jTable2.getValueAt(jTable2.getSelectedRow(), 0));
        banco.setDescricao(jtfDescricao.getText());
       ...
       // modeloTable = (DefaultTableModel) jTable2.getModel();
        ...
        for (Banco banco : listaBanco){
          ...
          //  jTable2.setValueAt();
            ...
            amodel.addRow(new Object[]{banco.getId(),banco.getDescricao()});
