 ...
 * @author del
 */
public class SubCategoriaPagamentoView extends javax.swing.JFrame {
    ...
    public SubCategoriaPagamentoView() {
        initComponents();
        carregaTable();
    ...
    private void initComponents() {
        ...
        setTitle("Cadastros de Sub-Categoria Conta");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Pesquisa Sub Categoria Pagamento"));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados de Sub Categoria Pagamento"));
        ...
        //if ((evt.getKeyCode() == evt.VK_ENTER) ){
          ...
          if (evt.getKeyCode() == evt.VK_ENTER){
            if (jtfDescricao.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "O campo Descrição não pode ser vazio ou nullo!!!");
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
            ...
            try {
        //        corretDAO.excluir(id);
                subCategoriaDAO.excluir(id);
                jbtCancelarActionPerformed(evt);
                JOptionPane.showMessageDialog(null, "Sub-Categoria Pagamento Excluido com Sucesso !!!");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Problemas ao Excluir Sub-Categoria Pagamento. Error:" + e.getMessage());
            }
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        try {
            ...
            JOptionPane.showConfirmDialog(null, "Problemas ao salvar Sub-Categoria Pagamento. Error:"+ex.getMessage());
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        for (SubCategoriaConta b : listaSubCategoria){
    ...
    private void carregaTable(){
        ...
        try{
           ...
           for (SubCategoriaConta b : listaSubCategoria){
               amodel.addRow(new Object[]{b.getId(), b.getDescricao()});            
           }
        }catch (Exception ex){
             JOptionPane.showMessageDialog(null, "Problemas ao Carregar Tabela de Sub-Categoria Conta. Error:"+ex.getMessage());
        }
    }
    public void limpar() {
       jtfCodigo.setText("");
    ...
    public void salvar() throws ParseException{
        SubCategoriaConta b = new SubCategoriaConta();
        ...
        try{
           subCategoriaDAO.salvar(b);
           if (operacao == "alterar")
               JOptionPane.showMessageDialog(null, "Sub-Categoria Conta Alterado com Sucesso!!!");
           else
               JOptionPane.showMessageDialog(null, "Sub-Categoria Conta Cadastrado com Sucesso!!!");
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, "Problemas ao Salvar Sub-Categoria Conta. Error:"+e.getMessage());
        }
